function LC_Pass(markerSet, filePath,viconPath)
fprintf('\n \n \n \n %%%%%% STARTING LOAD CELL PASS %%%%%% \n \n \n \n');
...
vicon.RunPipeline('Reconstruct And Label LC 2', '', 1000);
...
try
    ...
    pause(5)
    Gap_Fill_LC(markerSet,workingFilename,filePath)
    pause(1)
    clean = false;
    counter = 1;
